        ...
        if(windowWidth > 0) {
            if ($(document).scrollTop() >= 100) {
                ...
                if($('.do-sticky').length < 1) {
                    $('.company-logo img').attr('src', 'frontend/img/logos/reiseZielHamburg-logo-black.png');
                }
            }
            else {
                $('.sticky-header').removeClass('header-shrink');
                if($('.do-sticky').length < 1 && $('.fixed-header').length == 0 && $('.fixed-header2').length == 0) {
                    $('.company-logo img').attr('src', 'frontend/img/logos/reiseZielHamburg-logo.png');
                } else {
                    $('.company-logo img').attr('src', 'frontend/img/logos/reiseZielHamburg-logo-black.png');
                }
            }
        } else {
            $('.company-logo img').attr('src', 'frontend/img/logos/reiseZielHamburg-logo-color.png');
        }
    }
